...
class InputParser {
    ...
    _parseStorage(input, parentOutput, storage, options) {
        ...
        if (isFlowInput) {
            let resFlowInput = options.flowInput;
            if (resFlowInput && resFlowInput.metadata) {
                resFlowInput = { ...options.flowInput, metadata: { [reference]: resFlowInput.metadata[reference] } };
            }
            parentOutput.push({
                type,
